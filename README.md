...
```bash
bitasmbl pull --repoUrl https://github.com/he1snber8/Bitasmbl_back-home-smokin-legal_765_394 --appId 394 --repoId 216
```

## 3) Enter into the main directory and start coding!

```bash
cd Bitasmbl_back-home-smokin-legal_765_394
```
